...
import ComprarServico from '../../components/registrarCompraServicoModal/comprarServico';
import { DataGrid } from '@mui/x-data-grid';
import React, { Component } from 'react';

const columns = [
    { field: 'id', headerName: 'ID', width: 90 },
    { field: 'servico', headerName: 'Serviço', width: 300, editable: true, align: 'center', headerAlign: 'center' },
    { field: 'preco', headerName: 'Preço', width: 300, editable: true, align: 'center', headerAlign: 'center' },
    { field: 'consumo', headerName: 'Consumo', width: 150, editable: true, align: 'center', headerAlign: 'center' },
    { field: 'data', headerName: 'Data', sortable: true, align: 'center', headerAlign: 'center', width: 300 },
];
    ...
    render() {
        ...
        return (
            <>
                ...
                <ComprarServico open={openModal} setOpen={(status) => this.setState({ openModal: status })} />
            </>
        );
    }
}
